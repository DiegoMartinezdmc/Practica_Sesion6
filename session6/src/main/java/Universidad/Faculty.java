...
public class Faculty {
	...
	/**
	 * Adds a coordination to the list.
	 *
	 * @param id the coordination code
	 * @param name the coordination name
	 */
	...
	public String toString() {
		return "Faculty{" + "building=" + building + ", id=" + id + ", name=" + name + ", coordinations=" + coordinations + '}';
	}
}
